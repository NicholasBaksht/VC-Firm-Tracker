...
/**
 * TEAM-PAGES-DATA.JS
 * Real, individually-verified official "Team" page URLs for each
 * firm - not guessed from a URL pattern. Built incrementally in
 * batches; firms not yet in this list simply don't show a Team
 * Page link until verified. null means genuinely checked and
 * either no team page exists or the URL couldn't be confirmed.
 */
const TEAM_PAGES = {
