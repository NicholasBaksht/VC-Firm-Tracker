const firms = [
  ...
  },
  {
    ...
    hq: 'Palo Alto, CA',
    aum: '~$2.5B',
    sectors: ['AI', 'AI Infrastructure', 'SaaS'],
    thesis: 'Wing invests in companies building the AI-powered enterprise stack - scalable data platforms, AI model development, and autonomous applications with product-led growth strategies.',
    holdings: [],
    signatureExit: 'Backed Jasper Technologies, the IoT platform Cisco acquired for $1.4B in 2016',
  },
  {
    slug: 'soma-capital',
    rank: null,
  ...
  },
  {
    ...
    hq: 'San Francisco, CA',
    aum: '>$100B',
    sectors: ['SaaS', 'Consumer Internet', 'Fintech'],
    thesis: 'ICONIQ partners with visionaries transforming industries, leveraging its network of Silicon Valley founders to co-invest in fast-growing software and consumer internet companies across private growth rounds and public equity.',
    holdings: [
      ...
      { name: 'Zoom', ticker: 'ZM', price: null, historicalPrice: null },
    ],
